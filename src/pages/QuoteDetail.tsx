...
import { Typography, Card as AntCard, Button, Table, Space, Tag, Row, Col, Descriptions, theme, Tabs, Input, InputNumber, Modal, Tooltip, List, Progress, Select, Badge, Avatar, Popconfirm, message } from 'antd';
import { ArrowLeftOutlined, SendOutlined, EditOutlined, DownloadOutlined, SaveOutlined, PlusOutlined, DeleteOutlined, RobotOutlined, ExclamationCircleOutlined, CopyOutlined, MessageOutlined, EyeOutlined, MailOutlined } from '@ant-design/icons';
    ...
    <div style={{ paddingBottom: 40 }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', marginBottom: 24, gap: 16 }}>
        ...
        <div style={{ marginLeft: 'auto' }}>
          <Space>
            <Button icon={<CopyOutlined />} onClick={handleDuplicateQuote}>Duplicate</Button>
            <Button icon={<DownloadOutlined />}>Download PDF</Button>
            <Button icon={<EyeOutlined />} onClick={() => setShowTracking(true)}>Tracking</Button>
